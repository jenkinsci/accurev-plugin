...
public class History extends Command {
   ...
   * @param stream stream
   * @param transactionType Transaction type Specify what type of transaction to search for (can be
   *     null)
  ...
  public static AccurevTransaction getLatestTransaction( //
    ...
    if (transactionFound == null) {
      final String msg =
          "History command failed when trying to get the latest transaction of type "
              + transactionType;
