...
public final class ParseShowStreams
    implements ICmdOutputXmlParser<Map<String, AccurevStream>, String> {

  public Map<String, AccurevStream> parse(XmlPullParser parser, String depot)
    ...
    while (parser.next() != XmlPullParser.END_DOCUMENT) {
      if (parser.getEventType() == XmlPullParser.START_TAG
          && "stream".equalsIgnoreCase(parser.getName())) {
        ...
        try {
          ...
          final Long basisStreamNumber =
              basisStreamNumberStr == null ? null : Long.valueOf(basisStreamNumberStr);
