...
public class ParseFiles
    implements AccurevLauncher.ICmdOutputXmlParser<Boolean, List<AccurevElement>> {

  @Override
  public Boolean parse(XmlPullParser parser, List<AccurevElement> context)
      throws AccurevLauncher.UnhandledAccurevCommandOutput, IOException, XmlPullParserException {
